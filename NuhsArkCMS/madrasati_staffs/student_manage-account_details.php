...
<div class="jumbotron">
	...
	<div class="DashboardInfo">
		<a id="home" href="index.php">Home</a><i class="fa fa-chevron-right"></i><a href="student_manage-account.php">All Students</a><i class="fa fa-chevron-right"></i><a href="#">Student Details</a>
	</div>
</div>

<div class="container-fluid d-flex float-left studentDetails">
