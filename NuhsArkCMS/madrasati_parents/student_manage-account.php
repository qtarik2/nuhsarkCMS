...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_students WHERE StudentID='$Username'"
);
...
// $Username=$_SESSION['username'];
$count=1;
$sel_query="SELECT * FROM madrasati_students WHERE StudentID='$Username' LIMIT $offset, $total_records_per_page;";
...
<td align="left">
<a href="student_manage-account_details.php?StudentID=<?php echo $row["StudentID"]; ?>">DETAILS</a></td>
</tr>
<?php $count++; } ?>
