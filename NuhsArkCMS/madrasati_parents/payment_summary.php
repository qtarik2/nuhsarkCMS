...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_payment WHERE StudentID='$Username'"
);
...
// $Username=$_SESSION['username'];
$count=1;
$sel_query="SELECT * FROM madrasati_payment WHERE StudentID='$Username' LIMIT $offset, $total_records_per_page;";
...
<td align="left">
<a target="_blank" href="payment_view.php?ReceiptNo=<?php echo $row["ReceiptNo"]; ?>">VIEW RECEIPT</a></tr>
<?php $count++; } ?>
