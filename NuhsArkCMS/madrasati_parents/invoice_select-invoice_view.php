...
$count=1;
$sel_query="SELECT * FROM madrasati_invoice WHERE StudentID='$Username' AND InvoiceNo='$InvoiceNo'";
...
<table style="width: 100%" cellspacing="0" cellpadding="5">
				<tr>
								...
								<img alt="" src="../images/logo_madrasati.png" width="195" height="195"></td>
								<td>
<h2 class="style25">
								MADRASATI MONTESSORI PRIMARY SCHOOL<br>
								2A, JALAN JASPER 7/15, SEKSYEN 7,<br>
								40000, SHAH ALAM, SELANGOR.<br>
								Tel: 019-336 2789<br>
								Email: madrasatihq@gmail.com<br>
								www.madrasati.edu.my</h2>
<p class="style14">
								&nbsp;</p>
								</td>
				</tr>
...
<table style="width: 100%" cellspacing="0" cellpadding="5">
				...
				<tr>
								...
								payable to:<br>
								“MAAHAD MADRASATI PLT" CIMB 8603448424<br>
								<br>
