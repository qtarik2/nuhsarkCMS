...
$con,
"SELECT COUNT(*) As total_records FROM students WHERE EmailAddress='$Username'"
);
...
// $Username=$_SESSION['username'];
$count=1;
$sel_query="SELECT * FROM students WHERE EmailAddress='$Username' LIMIT $offset, $total_records_per_page;";
