...
<thead>
<tr>
<th class="style21">INVOICE NO</th>
<th class="style21">EMAIL ADDRESS</th>
<th class="style21">STUDENT ID</th>
<th class="style21">NAME</th>
<th class="style21">INVOICE NO</th>
<th class="style21">DATE</th>
<th class="style21">AMOUNT</th>
<th class="style21"><strong>MANAGE</strong></th>
...
$con,
"SELECT COUNT(*) As total_records FROM invoice WHERE StudentID='$Username'"
);
...
// $Username=$_SESSION['username'];
$count=1;
$sel_query="SELECT * FROM invoice WHERE StudentID='$Username' LIMIT $offset, $total_records_per_page;";
