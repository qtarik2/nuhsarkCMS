...
$con,
"SELECT COUNT(*) As total_records FROM students WHERE StudentID='$Username'"
);
...
// $Username=$_SESSION['username'];
$count=1;
$sel_query="SELECT * FROM students WHERE StudentID='$Username' LIMIT $offset, $total_records_per_page;";
