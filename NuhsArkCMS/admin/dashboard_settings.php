    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="dashboard-settings.php">Dashboard Settings</a></li>
        </ul>
    </ul>
...
$(function() {
 ...
 yearRange: "-100:+0"
																												...
																												<tr>
																																...
																																<td><input type="text" id="EPFEmployer" name="EPFEmployer" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" value="<?php echo $row["EPFEmployer"]; ?>" /> *UNDER DEVELOPMENT</td>
																												</tr>

																												<tr>
																																<td style="width: 170px" class="style14">EPF Employee</td>
																																<td><input type="text" id="EPFEmployee" name="EPFEmployee" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" value="<?php echo $row["EPFEmployee"]; ?>" /> *UNDER DEVELOPMENT</td>
																												</tr>
