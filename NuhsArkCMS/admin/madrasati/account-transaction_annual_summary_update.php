...
<body>
<div class="form" style="width: 100%">
<h2>EXPENSES &gt; ANNUAL BILLS &gt; SUMMARY</h2>
...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_expenses WHERE Type = 'ANNUAL BILLS' AND Backdated LIKE '%$Date' ORDER BY ID ASC "
);
...
?>
            ...
            if(isset($_POST['update'])){
                foreach($_POST['update'] as $updateid){
                    ...
                    // if($fname !='' && $lname !='' && $age >0 && $salary >0 && $email != '' ){
                        $updateUser = "UPDATE madrasati_expenses SET 
                            Backdated='".$Backdated."',
                            Date='".$Date."',
                            Type='".$Type."',
                            Name='".$Name."',
       ...
       $query = "SELECT * FROM madrasati_expenses WHERE Type = 'ANNUAL BILLS' AND Backdated LIKE '%$Date' ORDER BY ID ASC";
...
$(function() {
 ...
 yearRange: "-100:+0"
		   ...
		   <td>
		    <a href="account-transaction_delete-transaction.php?ID=<?php echo $row["ID"]; ?>">DELETE</a>
		   </td>
         </tr>
       <?php
