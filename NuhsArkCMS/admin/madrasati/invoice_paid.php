...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_invoice WHERE Status LIKE 'PAID'"
);
...
$count=1;
$sel_query="SELECT * FROM madrasati_invoice WHERE Status LIKE 'PAID' LIMIT $offset, $total_records_per_page;";
