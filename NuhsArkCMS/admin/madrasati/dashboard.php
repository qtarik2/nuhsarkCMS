...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="dashboard.php">MADRASATI</a>
    </div>
...
$count=1;
$sel_query="SELECT * FROM madrasati_invoices WHERE Date LIKE '%$Month'";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) {
}
...
$count=1;
$sel_query="SELECT * FROM madrasati_invoice WHERE Date LIKE '%2020'";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) {
}

// Calculation
    	$QuerySum1 = "SELECT SUM(Amount) FROM madrasati_invoice WHERE Date LIKE '%2020'";
	 	if ($result1 = mysqli_query($con, $QuerySum1)) {
		    /* fetch associative array */
		    while ($row = mysqli_fetch_array($result1)) {
...
$count=1;
$sel_query="SELECT * FROM madrasati_payment WHERE Date LIKE '%2020'";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) {
}

// Calculation
    	$QuerySum1 = "SELECT SUM(Amount) FROM madrasati_payment WHERE Date LIKE '%2020'";
	 	if ($result1 = mysqli_query($con, $QuerySum1)) {
		    /* fetch associative array */
		    while ($row = mysqli_fetch_array($result1)) {
...
$count=1;
$sel_query="SELECT * FROM madrasati_expenses WHERE Date LIKE '%2020'";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) {
}

// Calculation
    	$QuerySum1 = "SELECT SUM(Amount) FROM madrasati_expenses WHERE Date LIKE '%2020'";
	 	if ($result1 = mysqli_query($con, $QuerySum1)) {
		    /* fetch associative array */
		    while ($row = mysqli_fetch_array($result1)) {
...
$count=1;
$sel_query="SELECT * FROM madrasati_invoice WHERE Status LIKE 'PAID'";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) {
}

// Calculation
    	$QuerySum1 = "SELECT COUNT(InvoiceNo) FROM madrasati_invoice WHERE Status LIKE 'PAID'";
	 	if ($result1 = mysqli_query($con, $QuerySum1)) {
		    /* fetch associative array */
		    while ($row = mysqli_fetch_array($result1)) {
...
$count=1;
$sel_query="SELECT * FROM madrasati_invoice WHERE Status LIKE 'PARTIAL PAID'";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) {
}

// Calculation
    	$QuerySum1 = "SELECT COUNT(InvoiceNo) FROM madrasati_invoice WHERE Status LIKE 'PARTIAL PAID'";
	 	if ($result1 = mysqli_query($con, $QuerySum1)) {
		    /* fetch associative array */
		    while ($row = mysqli_fetch_array($result1)) {
...
$count=1;
$sel_query="SELECT * FROM madrasati_invoice WHERE Status LIKE 'UNPAID'";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) {
}

// Calculation
    	$QuerySum1 = "SELECT COUNT(InvoiceNo) FROM madrasati_invoice WHERE Status LIKE 'UNPAID'";
	 	if ($result1 = mysqli_query($con, $QuerySum1)) {
		    /* fetch associative array */
		    while ($row = mysqli_fetch_array($result1)) {
