...
$query = "SELECT * FROM madrasati_invoice WHERE InvoiceNo='".$InvoiceNo."'"; 
...
<body>
<div class="form" style="width: 100%">
<h2>INVOICE &gt; SELECT INVOICE &gt; UPDATE</h2>
...
$Amount = $AnnualFees + $TermFees;

	$update="UPDATE madrasati_invoice SET 
	Date='".$Date."', 
	Amount='".$Amount."', 
	Status='".$Status."',
	...
	print("<a href='invoice_select-student.php'>ADD DATA</a>");
	print("<br>");  
	print("<a href='invoice_select-invoice.php'>SUMMARY</a>");
	print("<br>");
	}
	else {
	?>
...
<table class="table">
				...
				<tr>
								...
								<td style="width: 442px"><?php echo $row["Programme"]; ?></td>
								<td>&nbsp;</td>
				</tr>
				<tr>
...
$(function() {
 ...
 yearRange: "-100:+0"
				...
				<tr>
								<td style="width: 150px">Invoice No</td>
								<td style="width: 442px"><?php echo $row["InvoiceNo"]; ?><br><input name="InvoiceNo" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" maxlength="100" size="100" value="<?php echo $row["InvoiceNo"]; ?>"></td>
								<td>
								</td>
				</tr>
				<tr>
								<td style="width: 150px">Amount</td>
								<td style="width: 442px"><?php echo $row["Amount"]; ?><br>AUTO CALCULATE</td>
								<td>
								&nbsp;</td>
				</tr>
				<tr>
								<td style="width: 150px">Status</td>
								<td style="width: 442px"><?php echo $row["Status"]; ?><br><select name="Status" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;">
