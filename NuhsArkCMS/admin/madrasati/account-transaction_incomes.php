...
<link rel="stylesheet" href="../nuhsark/css/style.css" />
<body>
...
<form method="post" action="account-transaction_incomes_update.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
																								<table class="table">
																												<tr>
