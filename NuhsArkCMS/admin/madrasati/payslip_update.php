...
<body>
<div class="form" style="width: 100%">
<h2>PAYSLIP &gt; SELECT STAFF &gt; UPDATE PAYSLIP</h2>
...
$AbsentDays=$_REQUEST['AbsentDays'];
...
$Notes1=$_REQUEST['Notes1'];
	...
	$update = "UPDATE madrasati_payslip SET
	Month='$Month', Name='$Name', Position='$Position', ICNo='$ICNo', EPFNo='$EPFNo',
	GrossBasic='$GrossBasic', NettBasic='$NettBasic', GrossAllowance='$GrossAllowance', NettAllowance='$NettAllowance',
	EPFEmployer='$EPFEmployer', SOCSOEmployer='$SOCSOEmployer', SOCSOSIPEmployer='$SOCSOSIPEmployer',
	Claims='$Claims', GrossEarnings='$GrossEarnings', NettEarnings='$NettEarnings',
	EPFEmployee='$EPFEmployee', SOCSOEmployee='$SOCSOEmployee', SOCSOSIPEmployee='$SOCSOSIPEmployee', Others='$Others',
	TotalDeductions='$TotalDeductions', NettSalary='$NettSalary',
	ApprovedBy='$ApprovedBy', ChequeNo='$ChequeNo', Date='$Date', ReceivedBy='$ReceivedBy', Notes='$Notes', Notes1='$Notes1', DayRate='$DayRate', AbsentDays='$AbsentDays', Advance='$Advance'
	WHERE ID='$ID'";
...
<table class="table">
				...
				<tr>
								...
								<td>
								<input name="EPFEmployee" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" maxlength="100" size="100" value="<?php echo $row["EPFEmployee"]; ?>"></td>
				</tr>
				<tr>
								<td style="width: 150px">SOCSO</td>
				...
				<tr>
								<td style="width: 150px">Day Rate</td>
								<td style="width: 442px"><?php echo $row["DayRate"]; ?></td>
								<td>
								<input name="DayRate" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" maxlength="100" size="100" value="<?php echo $row["DayRate"]; ?>"></td>
				</tr>
				<tr>
								<td style="width: 150px">Absent Days</td>
								<td style="width: 442px"><?php echo $row["AbsentDays"]; ?></td>
								<td>
								<input name="AbsentDays" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" maxlength="100" size="100" value="<?php echo $row["AbsentDays"]; ?>">
								&nbsp;</td>
				</tr>
				<tr>
								<td style="width: 150px">Absent Deduction</td>
				...
				<tr>
								<td style="width: 150px">Advance</td>
								<td style="width: 442px"><?php echo $row["Advance"]; ?></td>
								<td>
								<input name="Advance" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" maxlength="100" size="255" value="<?php echo $row["Advance"]; ?>"></td>
				</tr>
				<tr>
