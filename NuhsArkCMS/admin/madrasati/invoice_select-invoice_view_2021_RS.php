...
$count = 1;
$sql = "Select * FROM madrasati_invoice WHERE InvoiceNo = '$InvoiceNo'";
...
while($Invoice = mysqli_fetch_assoc($result)) {
	...
	// Header
	// Logo
	$pdf->Image('../../images/logo_madrasati.png',10,10, -700);
	...
	$pdf -> Cell (40);
	$pdf -> Cell (69, 5, 'Tel: +60 19 337 2789', 0, 1);
	$pdf -> Cell (40);
	$pdf -> Cell (69, 5, 'Email: madrasatihq@gmail.com', 0, 1);
	$pdf -> Cell (40);
	$pdf -> Cell (69, 5, 'URL: www.madrasati.edu.my', 0, 1);
	...
	$pdf -> Cell (20, 7, 'Returning Student', 0, 1);
	...
	$pdf -> Cell (40, 10, '0.00 (Carry Forward)', 1, 0);
	...
	$pdf -> Cell (40, 10, '250.00 (Optional)', 1, 0);
	...
	$pdf -> Cell(50, 5, 'CIMB BANK', 0, 1);
	$pdf -> Cell(40, 5, ' Account Holder', 0, 0);
	$pdf -> Cell(50, 5, 'MAAHAD MADRASATI PLT', 0, 1);
	$pdf -> Cell(40, 5, ' Account Number', 0, 0);
	$pdf -> Cell(50, 5, '86034-48424', 0, 1);
	$pdf -> Ln(2);
	$pdf -> Multicell (189, 5, 'Please send us the proof of payment to madrasatihq@gmail.com or +60193372789');
	$pdf -> Ln(2);
	...
	$Query_Payment="SELECT * FROM madrasati_payment WHERE StudentID='$StudentTemp'";
	...
	while($row = mysqli_fetch_assoc($result_account_1)) {
		...
		$pdf -> Ln(3);
		$pdf -> SetFont ('Calibri', '', 9);
		$pdf -> Cell (45, 7, 'Note', 0, 0);
		$pdf -> Cell (144, 7, 'Total wave is based on remarks on the page 1 of this invoice.', 0, 1);
		$pdf -> Cell (45, 7, 'Total Entitlement Fee', 0, 0);
		$pdf -> Cell (144, 7, 'MYR '.$row["AnnualTermFeesRevised"]. ' (Revised Annual Fees)', 0, 1);
