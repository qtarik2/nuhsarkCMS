...
<form method="post" action="invoice_select-student_create-invoice_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
<h2>INVOICE &gt; SELECT STUDENT &gt; CREATE INVOICE &gt; RESULT</h2>
...
$Amount = $AnnualFees + $TermFees;
	...
	$query = "INSERT INTO madrasati_invoice VALUES (NULL, '$EmailAddress', '$StudentID', '$Name', '$Date', '$Registration', '$Security', '$Program', '$Equipment', '$Uniform', '$Takaful', '$Extra1', '$Term', '$Extra2', '$TermInfo', '$Amount', 'UNPAID', 'Due1', 'Due2', 'Due3', '$Programme')";
