...
<form method="post" action="report_account-statement-report-annual_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
																								<span class="style22"><h2>ANNUAL ACCOUNT STATEMENT REPORT</h2></span>
																								<table class="table">
																												<tr>
																																<td style="width: 170px" class="style14">Year</td>
																																<td><input type="text" name="Month" class="date" readonly placeholder="YYYY" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" /> <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script><script src="https://code.jquery.com/ui/1.11.4/jquery-ui.js"></script><script>
$(function() {
 $( ".date" ).datepicker({
 dateFormat : 'yy',
 showOn: "both",
