...
$Closing=$_POST['Closing'];
	...
	$query = "INSERT INTO madrasati_ocbalance VALUES (NULL, '$Date', '$Opening', '$Closing')";
	mysqli_query($con, $query);
	// $querytrans = "INSERT INTO accountstatement VALUES (NULL, '$Date', '$Type', '$Name', '', '$ID', '0.00', '$Amount')";
	// mysqli_query($con, $querytrans);
