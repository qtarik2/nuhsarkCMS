...
<form method="post" action="account-transaction_incomes_add-transaction_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
<h2>INCOMES &gt; MONTHLY INCOMES &gt; NEW TRANSACTION &gt; RESULT</h2>
...
$Status=$_POST['Status'];
	...
	$query = "INSERT INTO madrasati_incomes VALUES (NULL, '$Date', '$Backdated', '$Type', '$Name', '$Amount', '$AccountNo', '$AdditionalInfo', '$Status')";
	mysqli_query($con, $query);
	
	print("<br>DATA UPDATED!");
	print("<br><br>");
	print("<a href='account-transaction_incomes_add-transaction.php'>ADD DATA</a>");
	print("<br>");  
	print("<a href='account-transaction_incomes.php'>SUMMARY</a>");
	print("<br>");
