...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="post" action="payment_select-student_payment_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
<h2>PAYMENT &gt; SELECT STUDENT &gt; PAYMENT</h2>
...
$count=1;
$sel_query="SELECT * FROM madrasati_students WHERE StudentID='$StudentID'";
