...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_staff"
);
...
$count=1;
$sel_query="SELECT * FROM madrasati_staff LIMIT $offset, $total_records_per_page;";
...
<td align="left"><?php echo $row["EPFEmployee"]; ?></td>
<td align="left"><?php echo $row["EPFEmployer"]; ?></td>
<td align="left"><?php echo $row["SOCSOEmployee"]; ?></td>
<td align="left"><?php echo $row["SOCSOEmployer"]; ?></td>
<td align="left"><?php echo $row["SOCSOSIPEmployee"]; ?></td>
<td align="left"><?php echo $row["SOCSOSIPEmployer"]; ?></td>
<td align="left">
<a href="payslip_select-staff_create-payslip.php?ID=<?php echo $row["ID"]; ?>">CREATE PAYSLIP</a> |
<a href="payslip_select-staff_summary.php?ID=<?php echo $row["ID"]; ?>">SUMMARY</a></tr>
<?php $count++; } ?>
