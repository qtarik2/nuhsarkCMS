...
<tr><td colspan="11">PRIMARY MADRASATI HALF DAY</td></tr>
<tbody>
<?php
...
$count=1;
$sel_query="SELECT * FROM madrasati_statement WHERE StudentID LIKE '$Month%' AND Code='1'";
...
<tr><td colspan="11">PRIMARY MADRASATI FULL DAY</td></tr>
<tbody>
<?php
// $Username=$_SESSION['username'];
$Month='2020';
...
$count=1;
$sel_query="SELECT * FROM madrasati_statement WHERE StudentID LIKE '$Month%' AND Code='2'";
// $sel_query="SELECT * FROM accountsummary WHERE Year LIKE '%$Month' ORDER BY StudentID ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { 
...
$count=1;
$sel_query="SELECT * FROM madrasati_statement WHERE StudentID LIKE '$Month%' AND Code='3'";
// $sel_query="SELECT * FROM accountsummary WHERE Year LIKE '%$Month' ORDER BY StudentID ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { 
...
$count=1;
$sel_query="SELECT * FROM madrasati_statement WHERE StudentID LIKE '$Month%' AND Code='4'";
// $sel_query="SELECT * FROM accountsummary WHERE Year LIKE '%$Month' ORDER BY StudentID ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { 
