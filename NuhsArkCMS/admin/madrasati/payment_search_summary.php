...
<body>
<div class="form" style="width: 100%">
<h2>PAYMENT &gt; SEARCH &gt; SELECT PAYMENT</h2>
...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_payment WHERE Date LIKE '%$Month' ORDER BY ReceiptNo DESC;"
);
...
?>
            ...
            if(isset($_POST['update'])){
                foreach($_POST['update'] as $updateid){
                    ...
                    // if($fname !='' && $lname !='' && $age >0 && $salary >0 && $email != '' ){
                        $updateUser = "UPDATE madrasati_payment SET 
                            Status1='".$Status1."',
                            Status2='".$Status2."',
                            Status3='".$Status3."'
       ...
       $query = "SELECT * FROM madrasati_payment WHERE Date LIKE '%$Month' ORDER BY ReceiptNo DESC LIMIT $offset, $total_records_per_page;";
