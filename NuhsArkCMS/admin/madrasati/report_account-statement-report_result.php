...
$count=1;
$sel_query="SELECT * FROM madrasati_incomes WHERE Date LIKE '%$Month' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM madrasati_expenses WHERE Date LIKE '%$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
// Calculation
    	...
    	$QuerySum5 = "SELECT SUM(Amount) FROM madrasati_expenses WHERE Date LIKE '%$Month' AND Account='NACC' AND Status='PAID'";
    	...
    	$QuerySum6 = "SELECT SUM(Amount) FROM madrasati_expenses WHERE Date LIKE '%$Month' AND Account='ROSELINA' AND Status='PAID'";
    	...
    	$QuerySum10 = "SELECT SUM(Amount) FROM madrasati_expenses WHERE Date LIKE '%$Month' AND Status='PAID'";
    	...
    	$QuerySum11 = "SELECT SUM(Amount) FROM madrasati_incomes WHERE Date LIKE '%$Month'";
