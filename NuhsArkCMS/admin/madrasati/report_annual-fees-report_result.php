...
<tr><td colspan="4">PRIMARY MADRASATI</td></tr>
<tbody>
<?php
...
$count=1;
$sel_query="SELECT * FROM madrasati_accountsummary WHERE StudentID LIKE '$Month%' AND Programme LIKE 'PRIMARY MADRASATI%'";
...
<tr><td colspan="4">PRIMARY MADRASATI FULL DAY</td></tr>
<tbody>
<?php
// $Username=$_SESSION['username'];
$Month=$_POST['Month'];
...
$count=1;
$sel_query="SELECT * FROM madrasati_accountsummary WHERE StudentID LIKE '$Month%' AND Programme LIKE 'PRIMARY MADRASATI FULL DAY%'";
// $sel_query="SELECT * FROM accountsummary WHERE Year LIKE '%$Month' ORDER BY StudentID ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { 
...
$count=1;
$sel_query="SELECT * FROM madrasati_accountsummary WHERE StudentID LIKE '$Month%' AND Programme ='KAFA'";
// $sel_query="SELECT * FROM accountsummary WHERE Year LIKE '%$Month' ORDER BY StudentID ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { 
...
<tr><td colspan="4">WITHDRAW</td></tr>
<tbody>
<?php
// $Username=$_SESSION['username'];
$Month=$_POST['Month'];
...
$count=1;
$sel_query="SELECT * FROM madrasati_accountsummary WHERE StudentID LIKE '$Month%' AND Programme ='WITHDRAW'";
// $sel_query="SELECT * FROM accountsummary WHERE Year LIKE '%$Month' ORDER BY StudentID ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { 
