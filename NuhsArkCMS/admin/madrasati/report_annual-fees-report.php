...
<form method="post" action="report_annual-fees-report_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
																								<span class="style22"><h2>ANNUAL FEES REPORT (ENTRANCE FEES REPORT)</h2></span>
																								<table class="table">
																												<tr>
