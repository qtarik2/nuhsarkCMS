...
$count=1;
$sel_query="SELECT * FROM madrasati_statement WHERE StudentID='$StudentID'";
...
<table style="width: 100%">
				...
				<tr>
								<td class="style29">MADRASATI MONTESSORI PRIMARY 
								SCHOOL<br>
								2A, JALAN JASPER 7/15, SEKSYEN 7, 40000, SHAH 
								ALAM, SELANGOR.<br>
								Tel: 019-336 2789<br>
								Email: madrasatihq@gmail.com Website: 
								www.madrasati.edu.my</td>
				</tr>
				<tr>
								<td>
								<table style="width: 100%">
...
$count_account_1=1;
$sel_query_account_1="SELECT * FROM madrasati_statement WHERE StudentID='$StudentTemp'";
