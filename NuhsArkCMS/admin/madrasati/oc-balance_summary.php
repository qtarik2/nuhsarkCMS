...
$count=1;
$sel_query="SELECT * FROM madrasati_ocbalance";
...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_ocbalance ORDER BY ID DESC"
);
...
$count=1;
$sel_query="SELECT * FROM madrasati_ocbalance ORDER BY ID DESC LIMIT $offset, $total_records_per_page;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $row["ID"]; ?></td>
<td align="left"><?php echo $row["Date"]; ?></td>
<td align="left"><?php echo $row["Opening"]; ?></td>
<td align="left"><?php echo $row["Closing"]; ?></td>
<td align="left">
<a href="oc-balance_update.php?ID=<?php echo $row["ID"]; ?>">DETAILS/UPDATE 
</a></td>
</tr>
<?php $count++; } ?>
