...
$count=1;
$sel_query="SELECT * FROM madrasati_payslip WHERE Date LIKE '%$Month';";
...
// Calculation
    	$QuerySum1 = "SELECT SUM(NettSalary) FROM madrasati_payslip WHERE Date LIKE '%$Month'";
	 	if ($result1 = mysqli_query($con, $QuerySum1)) {
		    /* fetch associative array */
		    while ($row = mysqli_fetch_array($result1)) {
	 			$TotalAmountMYR = $row['SUM(NettSalary)'];
	 		}
	 	}
	 	
echo "<br>Amount        : MYR $TotalAmountMYR";
echo "<br><br>";
