...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_invoice WHERE Status='UNPAID'"
);
...
$count=1;
$sel_query="SELECT * FROM madrasati_invoice WHERE Status='UNPAID' LIMIT $offset, $total_records_per_page;";
