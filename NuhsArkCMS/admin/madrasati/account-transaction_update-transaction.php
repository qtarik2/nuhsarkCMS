...
<body>
<div class="form" style="width: 100%">
<h2>EXPENSES &gt; MONTHLY/ANNUAL BILLS &gt; UPDATE TRANSACTION</h2>
...
$Status=$_REQUEST["Status"];
	...
	$update="UPDATE madrasati_expenses SET Date='".$Date."', Backdated='".$Backdated."', Name='".$Name."', Amount='".$Amount."', AccountNo='".$AccountNo."', AdditionalInfo='".$AdditionalInfo."', Status='".$Status."'  WHERE ID='".$ID."'";
...
$(function() {
 ...
 yearRange: "-100:+0"
				...
				<tr>
								...
								<td>
								<input type="text" name="Backdated" class="date" readonly placeholder="DD/MM/YYYY" style="font-family: Verdana; font-size: 16 pt; height: 30px; width: 220px;" value="<?php echo $row["Backdated"]; ?>" /><script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script><script src="https://code.jquery.com/ui/1.11.4/jquery-ui.js"></script><script>
$(function() {
 $( ".date" ).datepicker({
 dateFormat : 'dd/mm/yy',
 showOn: "both",
