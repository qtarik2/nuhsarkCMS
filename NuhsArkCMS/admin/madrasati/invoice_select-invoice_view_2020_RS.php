...
<table style="width: 100%" cellspacing="0" cellpadding="5">
				...
				<tr>
								<td class="style14"><strong>RETURNING STUDENT</strong></td>
				</tr>
				<tr>
								<td class="style14">
								<table style="width: 100%" cellspacing="0" cellpadding="5">
				...
				<tr>
								...
								<table style="width: 100%" cellspacing="0" cellpadding="5" class="style20">
												...
												<tr class="style26">
																...
																ADJUSTMENT</td>
																<td style="width: 125px">
																- MYR <?php echo $row["Term1Rebates"]; ?></td>
												</tr>
												<tr class="style26">
																<td style="width: 400px">
																[10] REBATES / 
...
<table style="width: 100%" cellspacing="0" cellpadding="5">
				...
				<tr>
								...
								<table style="width: 100%" cellspacing="0" cellpadding="5">
												...
												<tr>
																...
																(Item 2 - 6)</td>
																<td style="width: 320px">
																MYR <?php echo number_format($row["Security"]+$row["Equipment"]+$row["Program"]+$row["Uniform"]+$row["Takaful"]+$row["Extra1"], 2, '.', ''); ?></td>
				...
				<tr>
								<td class="style14">It&#39;s optional for parents to 
								choose payment monthly or termly basis whichever 
								comfortable.<br>
								<br>
								Due - <br>
								Term fee: 1st week of every term<br>
								<br>
								Or<br>
								<br>
								Monthly fee: 1st day of every month</td>
				<tr>
												...
												<tr>
																...
																<table style="width: 100%" cellspacing="0" cellpadding="5">
																				...
																				<tr>
																								...
																								<td class="style28">MYR <?php echo $row["Balance"]; ?> </td>
																				</tr>
																</table>
																</td>
												</tr>
