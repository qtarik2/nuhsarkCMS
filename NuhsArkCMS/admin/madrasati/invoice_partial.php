...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_invoice WHERE Status LIKE 'PARTIAL PAID'"
);
...
$count=1;
$sel_query="SELECT * FROM madrasati_invoice WHERE Status LIKE 'PARTIAL PAID' LIMIT $offset, $total_records_per_page;";
...
<td align="left">
<a target="_blank" href="invoice_select-invoice_view.php?InvoiceNo=<?php echo $row["InvoiceNo"]; ?>">VIEW INVOICE</a> | <br>
