...
$con,
"SELECT COUNT(*) As total_records FROM madrasati_incomes WHERE Backdated LIKE '%$Date' ORDER BY ID ASC "
);
...
?>
            ...
            if(isset($_POST['update'])){
                foreach($_POST['update'] as $updateid){
                    ...
                    // if($fname !='' && $lname !='' && $age >0 && $salary >0 && $email != '' ){
                        $updateUser = "UPDATE madrasati_incomes SET 
                            Backdated='".$Backdated."',
                            Date='".$Date."',
                            Type='".$Type."',
                            Name='".$Name."',
       ...
       $query = "SELECT * FROM madrasati_incomes WHERE Backdated LIKE '%$Date' ORDER BY ID ASC";
