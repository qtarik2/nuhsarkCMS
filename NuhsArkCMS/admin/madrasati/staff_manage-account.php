...
$count=1;
$sel_query="SELECT * FROM madrasati_staff;";
...
<td align="left"><?php echo $row["HiredDate"]; ?></td>
<td align="left">
<a href="staff_manage-account_update-account.php?ID=<?php echo $row["ID"]; ?>">UPDATE</a> 
| <a href="staff_manage-account_change-password.php?ID=<?php echo $row["ID"]; ?>">CHANGE PASSWORD</a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
