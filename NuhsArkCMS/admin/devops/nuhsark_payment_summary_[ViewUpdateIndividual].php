...
$Status3=$_REQUEST["Status3"];
	...
	$update="UPDATE payment SET Status1='".$Status1."', Status2='".$Status2."', Status3='".$Status3."' WHERE ReceiptNo='".$ReceiptNo."'";
	mysqli_query($con, $update) or die(mysqli_error());
	
	$Progress = "<br>DATA UPDATED FOR $ReceiptNo<br>";
	echo '<p style="color:#FF0000;">'.$Progress.'</p>';
	print("<a href='nuhsark_payment_summary.php'>REFRESH</a>");
	print("<br>");
	}
	else {
	?>
...
<a target="_blank" href="../nuhsark_payment_view.php?ReceiptNo=<?php echo $row["ReceiptNo"]; ?>">VIEW RECEIPT</a> |
...
| <a href="../nuhsark_payment_delete.php?ReceiptNo=<?php echo $row["ReceiptNo"]; ?>">DELETE RECEIPT</a></tr>
</form>
<?php
}
?>
