...
<body>
<div class="form" style="width: 100%">
<h2>TERM FEES REPORT</h2>
<p><a target="_blank" href="../nuhsark_report_term-fees-report_print.php">PRINT</a></p>
...
<th colspan="20">PRESCHOOL HALF DAY</th>
       ...
       ?>
         <tr>
		   ...
		   <td><?= $Extra2 ?></td>
		   <td><a target="_blank" href="../nuhsark_account-statement_details.php?StudentID=<?php echo $row["StudentID"]; ?>">STUDENT ACCOUNT STATEMENT</a> </td>
         </tr>
       <?php
