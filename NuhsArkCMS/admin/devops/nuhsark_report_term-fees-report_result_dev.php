...
<th>VIEW</th>
       ...
       <?php 
       $query = "SELECT * FROM accountsummary WHERE StudentID LIKE '$Month%'";
       ...
       ?>
         <tr>
           ...
           <td><?= $Programme ?></td>
           <td><?= $Term ?></td>
           <td><input type='text' name='M01_<?= $ID ?>' value='<?= $M01 ?>' ></td>
           <td><input type='text' name='M02_<?= $ID ?>' value='<?= $M02 ?>' ></td> 
           <td><input type='text' name='M03_<?= $ID ?>' value='<?= $M03 ?>' ></td>
           <td><input type='text' name='M04_<?= $ID ?>' value='<?= $M04 ?>' ></td> 
           <td><input type='text' name='M05_<?= $ID ?>' value='<?= $M05 ?>' ></td>
           <td><input type='text' name='M06_<?= $ID ?>' value='<?= $M06 ?>' ></td> 
           <td><input type='text' name='M07_<?= $ID ?>' value='<?= $M07 ?>' ></td>
           <td><input type='text' name='M08_<?= $ID ?>' value='<?= $M08 ?>' ></td> 
           <td><input type='text' name='M09_<?= $ID ?>' value='<?= $M09 ?>' ></td>
           <td><input type='text' name='M10_<?= $ID ?>' value='<?= $M10 ?>' ></td> 
           <td><input type='text' name='M11_<?= $ID ?>' value='<?= $M11 ?>' ></td>
           <td><input type='text' name='M12_<?= $ID ?>' value='<?= $M12 ?>' ></td> 
		   <td><?= $Extra2 ?></td>
