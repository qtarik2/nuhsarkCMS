...
<form method='post' action=''>
     ...
     <!-- Submit button -->
    <p><button type="submit" class="btn btn-default" name='but_update'>Update All Data</button>&nbsp;<a href="../nuhsark_payment_search.php">SEARCH</a></p>
...
?>
       ...
       $query = "SELECT * FROM payment ORDER BY ReceiptNo DESC;";
       ...
       ?>
         ...
         <tr>
		   ...
		   <td><a target="_blank" href="../nuhsark_payment_view.php?ReceiptNo=<?php echo $row["ReceiptNo"]; ?>">VIEW RECEIPT</a> |
<a href="../nuhsark_payment_update.php?ReceiptNo=<?php echo $row["ReceiptNo"]; ?>">UPDATE RECEIPT</a> |
<a href="../nuhsark_account-statement_details.php?StudentID=<?php echo $row["StudentID"]; ?>">STUDENT ACCOUNT STATEMENT</a> 
| <a href="../nuhsark_payment_delete.php?ReceiptNo=<?php echo $row["ReceiptNo"]; ?>">DELETE RECEIPT</a></td>
         </tr>
       <?php
