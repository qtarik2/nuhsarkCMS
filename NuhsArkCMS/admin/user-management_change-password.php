...
<table class="table">
	<tr>
		...
		<td><input type="text" class="form-control" id="Username" name="Username" required name="Username" value="<?php echo $_SESSION['username']; ?>" readonly /></td>
	</tr>
	<tr>
		<td style="width: 170px" class="style14">Password</td>
		<td><input type="password" class="form-control" id="Password" name="Password" required name="Password" value="<?php echo $row["Password"]; ?>" /></td>
	</tr>
</table>
	<br>
