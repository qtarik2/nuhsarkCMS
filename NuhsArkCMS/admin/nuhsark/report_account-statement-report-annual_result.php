...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/01/$Month' ORDER BY PaymentDate ASC;";
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/01/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/02/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/02/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/03/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/03/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/04/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/04/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/05/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/05/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/06/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/06/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/07/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/07/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/08/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/08/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/09/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/09/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/10/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/10/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/11/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/11/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM payment WHERE PaymentDate LIKE '%/12/$Month' ORDER BY PaymentDate ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%/12/$Month' AND Status='PAID' ORDER BY Backdated ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $count; ?></td>
...
// Calculation
    	...
    	$QuerySum2 = "SELECT SUM(Surestart) FROM payment WHERE Date LIKE '%$Month'";
	 	...
	 	$QuerySum3 = "SELECT SUM(NACC) FROM payment WHERE Date LIKE '%$Month'";
    	...
    	$QuerySum4 = "SELECT SUM(MMP) FROM payment WHERE Date LIKE '%$Month'";
    	...
    	$QuerySum10 = "SELECT SUM(Amount) FROM expenses WHERE Backdated LIKE '%$Month'";
