...
// Calculation
    	...
    	$QuerySum2 = "SELECT SUM(AnnualFees) FROM payment WHERE PaymentDate LIKE '%$Month'";
    	...
    	$QuerySum3 = "SELECT SUM(TermFees) FROM payment WHERE PaymentDate LIKE '%$Month'";
    	...
    	$QuerySum4 = "SELECT SUM(MiscFees) FROM payment WHERE PaymentDate LIKE '%$Month'";
