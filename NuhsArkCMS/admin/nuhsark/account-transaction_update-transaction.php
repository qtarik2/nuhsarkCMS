...
$Status=$_REQUEST["Status"];
	...
	$update="UPDATE expenses SET Date='".$Date."', Backdated='".$Backdated."', Name='".$Name."', Amount='".$Amount."', AccountNo='".$AccountNo."', AdditionalInfo='".$AdditionalInfo."', Status='".$Status."'  WHERE ID='".$ID."'";
