...
$count=1;
$sel_query="SELECT * FROM accountstatement WHERE Date LIKE '%$Month' AND TransactionID='DEPOSITS' ORDER BY Date ASC;";
...
$count=1;
$sel_query="SELECT * FROM accountstatement WHERE Date LIKE '%$Month' AND TransactionID='WITHDRAWALS' ORDER BY Date ASC;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
<td align="left"><?php echo $row["Date"]; ?></td>
