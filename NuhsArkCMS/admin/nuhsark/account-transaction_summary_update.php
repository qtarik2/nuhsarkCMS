...
$con,
"SELECT COUNT(*) As total_records FROM expenses WHERE Type != 'ANNUAL BILLS' AND Backdated LIKE '%$Date' ORDER BY ID ASC "
);
...
?>
            ...
            if(isset($_POST['update'])){
                foreach($_POST['update'] as $updateid){
                    ...
                    // if($fname !='' && $lname !='' && $age >0 && $salary >0 && $email != '' ){
                        $updateUser = "UPDATE expenses SET 
                            Backdated='".$Backdated."',
                            Date='".$Date."',
                            Type='".$Type."',
                            Name='".$Name."',
       ...
       $query = "SELECT * FROM expenses WHERE Type != 'ANNUAL BILLS' AND Backdated LIKE '%$Date' ORDER BY ID ASC";
