...
$Amount = $AnnualFees + $TermFees;
	...
	$query = "INSERT INTO invoice VALUES (NULL, '$EmailAddress', '$StudentID', '$Name', '$Date', '$Registration', '$Security', '$Program', '$Equipment', '$Uniform', '$Takaful', '$Extra1', '$Term', '$Extra2', '$TermInfo', '$Amount', 'UNPAID', 'Due1', 'Due2', 'Due3', '$Programme')";
