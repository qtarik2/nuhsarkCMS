...
<form method="post" action="report_account-statement-report_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
																								<span class="style22"><h2>ACCOUNT STATEMENT REPORT (<a href="report_account-statement-reportv2.php">CLICK HERE FOR VERSION 2</a>)</h2></span>
																								<table class="table">
																												<tr>
