...
$count=1;
$sel_query="SELECT * FROM accountsummary WHERE StudentID='$StudentID'";
...
<td align="left"><?php echo $row["InvoiceNo"]; ?> INVOICE INVOICE VIEW AS | 
...
// Calculation
    	...
    	$QuerySum9 = "SELECT SUM(Term) FROM invoice WHERE StudentID='$StudentID'";
	 	if ($result9 = mysqli_query($con, $QuerySum9)) {
		    /* fetch associative array */
		    while ($row = mysqli_fetch_array($result9)) {
	 			$Annual_TermFees_Invoice = $row['SUM(Term)'];
	 		}
	 	}
    	...
    	$QuerySum4 = "SELECT SUM(TermFees) FROM payment WHERE StudentID='$StudentID'";
	 	...
	 	$Sum1 = "SELECT SUM(Registration) FROM payment WHERE StudentID='$StudentID'";
	 	...
	 	$Sum2 = "SELECT SUM(Security) FROM payment WHERE StudentID='$StudentID'";
	 	...
	 	$Sum3 = "SELECT SUM(Program) FROM payment WHERE StudentID='$StudentID'";
	 	...
	 	$Sum4 = "SELECT SUM(Equipment) FROM payment WHERE StudentID='$StudentID'";
	 	...
	 	$Sum5 = "SELECT SUM(Uniform) FROM payment WHERE StudentID='$StudentID'";
	 	...
	 	$Sum6 = "SELECT SUM(Takaful) FROM payment WHERE StudentID='$StudentID'";
	 	...
	 	$Sum7 = "SELECT SUM(Extra1) FROM payment WHERE StudentID='$StudentID'";
	 	...
	 	$Sum8 = "SELECT SUM(Extra2) FROM payment WHERE StudentID='$StudentID'";
		...
		$UpdateSum = "UPDATE accountsummary SET Debit='$InvoicesMYR', Credit='$PaymentsMYR', Balance='$BalanceMYR', Registration='$Registration', Security='$Security', Program='$Program', Equipment='$Equipment', Uniform='$Uniform', Takaful='$Takaful', Extra1='$Extra1', Extra2='$Extra2', Term='$TermFees' WHERE StudentID='$StudentID'";
