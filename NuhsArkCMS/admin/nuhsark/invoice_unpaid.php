...
$con,
"SELECT COUNT(*) As total_records FROM invoice WHERE Status LIKE 'UNPAID'"
);
...
$count=1;
$sel_query="SELECT * FROM invoice WHERE Status LIKE 'UNPAID' LIMIT $offset, $total_records_per_page;";
