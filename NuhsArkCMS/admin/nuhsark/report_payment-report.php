...
<form method="post" action="report_payment-report_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
																								<span class="style22"><h2>PAYMENT REPORT</h2></span><table class="table">
																												<tr>
