...
$con,
"SELECT COUNT(*) As total_records FROM invoice WHERE Status LIKE 'PARTIAL PAID'"
);
...
$count=1;
$sel_query="SELECT * FROM invoice WHERE Status LIKE 'PARTIAL PAID' LIMIT $offset, $total_records_per_page;";
