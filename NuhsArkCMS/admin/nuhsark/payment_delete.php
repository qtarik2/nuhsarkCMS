...
$query = "SELECT * FROM payment WHERE ReceiptNo='".$ReceiptNo."'"; 
...
$Amount = $AnnualFees + $TermFees;
	...
	$update="DELETE FROM payment WHERE ReceiptNo='".$ReceiptNo."'";
...
<br>
																								<p><button type="submit" class="btn btn-default">Delete</button></p></form>
</div>
<?php
}
?>
