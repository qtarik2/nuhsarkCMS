...
$count=1;
$sel_query="SELECT * FROM expenses WHERE Backdated LIKE '%$Month' AND Status='PAID'";
...
// Calculation
    	$QuerySum1 = "SELECT SUM(Amount) FROM expenses WHERE Backdated LIKE '%$Month' AND Status='PAID'";
