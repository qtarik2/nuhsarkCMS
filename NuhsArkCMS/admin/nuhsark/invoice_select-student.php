...
<td align="left">
<a href="invoice_select-student_create-invoice.php?StudentID=<?php echo $row["StudentID"]; ?>">CREATE INVOICE</a> |
<a href="invoice_select-student_summary.php?StudentID=<?php echo $row["StudentID"]; ?>">SUMMARY</a></tr>
<?php $count++; } ?>
