...
<form method="post" action="payment_select-invoice_payment_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
...
$Surestart = $Amount;
	...
	$query = "INSERT INTO payment VALUES (NULL, '$EmailAddress', '$StudentID', '$Name', '$InvoiceNo', '$Date', '$PaymentDate', '$Method', '$ChequeNo', '$Amount', '$Registration', '$Security', '$Program', '$Equipment', '$Uniform', '$Takaful', '$Extra1', '$Term', '$Extra2', '$Notes', '$AnnualFees', '$TermFees', '$MiscFees', '$Programme', '$Status1', '$Status2', '$Status3')";
	mysqli_query($con, $query);
		
	print("<br>DATA UPDATED!");
	print("<br><br>");  
	print("<a href='invoice_select-invoice.php'>ADD DATA</a>");
	print("<br>");  
