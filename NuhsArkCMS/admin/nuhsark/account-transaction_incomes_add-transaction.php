...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="post" action="account-transaction_incomes_add-transaction_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
<h2>INCOMES &gt; MONTHLY INCOMES &gt; NEW TRANSACTION</h2>
																								<table class="table">
																												<tr>
