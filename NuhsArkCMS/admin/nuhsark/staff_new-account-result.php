...
<h2>STAFF &gt; NEW ACCOUNT &gt; RESULT</h2>
...
$DayRate=$_POST['GrossBasic']/25;
	
	// Insert data into mysql 
	
	$query = "INSERT INTO staff (ID, Name, ICNo, EPFNo, Position, GrossBasic, EmailAddress, HiredDate, EPFEmployee, EPFEmployer, SOCSOEmployee, SOCSOEmployer, SOCSOSIPEmployee, SOCSOSIPEmployer, DayRate) VALUES (NULL, '$Name', '$ICNo', '$EPFNo', '$Position', '$GrossBasic', '$EmailAddress', '$HiredDate', '$EPFEmployee', '$EPFEmployer', '$SOCSOEmployee', '$SOCSOEmployer', '$SOCSOSIPEmployee', '$SOCSOSIPEmployer', '$DayRate')";
	mysqli_query($con, $query);

	print("<br>DATA UPDATED!");
	print("<br><br>"); 
	print("<a href='staff_new-account.php'>ADD DATA</a>");
	print("<br>");  
