...
<table style="width: 100%" cellspacing="0" cellpadding="5">
				<tr>
								...
								<img alt="" src="../../images/nuhsarklogo3.png" width="200" height="200"></td>
								<td>
<table style="width: 100%" cellspacing="0">
				<tr>
								<td class="style28">
								<h1 class="style33"><strong>PAYSLIP</strong></h1>
								</td>
				</tr>
				<tr>
								<td class="style29">Nuhs Ark Sdn. Bhd. 
								(470245-K)<br>
								2A, Jalan Jasper 7/15, Seksyen7,
								40000 Shah Alam, Selangor Darul Ehsan.<br>
								Tel : 03-5524 2489 
								E-mail : <a href="mailto:nuhsark61@gmail.com">
								nuhsark61@gmail.com</a></td>
				</tr>
				<tr>
								<td>
<table style="width: 100%" cellspacing="0">
				...
				<tr>
								...
								<table style="width: 100%" cellspacing="0" cellpadding="5">
												...
												<tr>
																...
																<td style="width: 25%" class="style26">
																ABSENT</td>
																<td style="width: 25%" class="style32">
