...
$con,
"SELECT COUNT(*) As total_records FROM payment WHERE Date LIKE '%$Month' ORDER BY ReceiptNo DESC;"
);
...
?>
       ...
       $query = "SELECT * FROM payment WHERE Date LIKE '%$Month' ORDER BY ReceiptNo DESC LIMIT $offset, $total_records_per_page;";
