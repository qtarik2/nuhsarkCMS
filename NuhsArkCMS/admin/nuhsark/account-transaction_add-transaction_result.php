...
<form method="post" action="account-transaction_add-transaction_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
<h2>EXPENSES &gt; MONTHLY/ANNUAL BILLS &gt; NEW TRANSACTION &gt; RESULT</h2>
...
$Status=$_POST['Status'];
	...
	$query = "INSERT INTO expenses VALUES (NULL, '$Date', '$Backdated', '$Type', '$Name', '$Amount', '$AccountNo', '$AdditionalInfo', '$Status')";
