...
<form method="post" action="account-statement_search_result.php" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
<h2>STUDENT STATEMENT &gt; SEARCH</h2>
																								<table class="table">
																												<tr>
