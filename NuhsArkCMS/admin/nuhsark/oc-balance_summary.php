...
$count=1;
$sel_query="SELECT * FROM ocbalance";
...
$con,
"SELECT COUNT(*) As total_records FROM ocbalance ORDER BY ID DESC"
);
...
$count=1;
$sel_query="SELECT * FROM ocbalance ORDER BY ID DESC LIMIT $offset, $total_records_per_page;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr>
