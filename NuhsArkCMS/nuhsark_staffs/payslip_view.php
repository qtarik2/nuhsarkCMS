...
$count = 1;
$sql = "Select * FROM payslip WHERE ID = '$PayslipID' AND ICNo = '$ICNo'";
...
while($Payslip = mysqli_fetch_assoc($result)) {
	...
	$pdf -> Cell (60);
	$pdf -> Cell (69, 5, 'Nuhs Ark Sdn. Bhd. (470245-K)', 0, 1);
	$pdf -> Cell (60);
	$pdf -> Cell (69, 5, '2A, Jalan Jasper, 7/15, Seksyen7,', 0, 1);
	$pdf -> Cell (60);
	$pdf -> Cell (69, 5, '40000, Shah Alam, Selangor Darul Ehsan.', 0, 1);
	$pdf -> Cell (60);
	$pdf -> Cell (69, 5, 'Tel : 03-5524 2489', 0, 1);
	$pdf -> Cell (60);
	$pdf -> Cell (10, 5, 'Email : ', 0, 0);
	$pdf -> SetTextColor (255, 0, 0);
	$pdf -> Cell (69, 5, 'nuhsark61@gmail.com', 0, 1);
	...
	$pdf -> Cell (50, 8, 'MYR '.$Payslip['GrossEarnings'], 1);
