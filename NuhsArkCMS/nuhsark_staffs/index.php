...
$sql = "SELECT * FROM students WHERE StudentID LIKE '%$searchByValue%' OR Name LIKE '%$searchByValue%'";
...
$sql = "SELECT * FROM students WHERE StudentID LIKE '%$searchByValue%' OR Name LIKE '%$searchByValue%' LIMIT ". $thisPageFirstResult .',' . $resultsPerPage ;
